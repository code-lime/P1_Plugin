...
public class AnyEvent {
    ...
    private static final HashMap<Toast2<String, Integer>, Event> events = new HashMap<>();
    ...
    public static <T>void addEvent(String event, type other, Func1<Builder<Player>, Builder<T>> build, Action1<T> execute) {
        ...
        events.put(Toast.of(event, data.tab.size()), data);
    }

//<generator name="AnyEvent.js">
    public static <T0, T1>void addEvent(String event, type other, Func1<Builder<Player>, Builder<Toast2<T0,T1>>> build, Action2<T0, T1> execute) {
        addEvent(event, other, build, (Action1<Toast2<T0,T1>>)execute);
    }
    public static <T0, T1, T2>void addEvent(String event, type other, Func1<Builder<Player>, Builder<Toast2<Toast2<T0,T1>,T2>>> build, Action3<T0, T1, T2> execute) {
        addEvent(event, other, build, (Action1<Toast2<Toast2<T0,T1>,T2>>)execute);
    }
    public static <T0, T1, T2, T3>void addEvent(String event, type other, Func1<Builder<Player>, Builder<Toast2<Toast2<Toast2<T0,T1>,T2>,T3>>> build, Action4<T0, T1, T2, T3> execute) {
        addEvent(event, other, build, (Action1<Toast2<Toast2<Toast2<T0,T1>,T2>,T3>>)execute);
    }
    public static <T0, T1, T2, T3, T4>void addEvent(String event, type other, Func1<Builder<Player>, Builder<Toast2<Toast2<Toast2<Toast2<T0,T1>,T2>,T3>,T4>>> build, Action5<T0, T1, T2, T3, T4> execute) {
        addEvent(event, other, build, (Action1<Toast2<Toast2<Toast2<Toast2<T0,T1>,T2>,T3>,T4>>)execute);
    }
    public static <T0, T1, T2, T3, T4, T5>void addEvent(String event, type other, Func1<Builder<Player>, Builder<Toast2<Toast2<Toast2<Toast2<Toast2<T0,T1>,T2>,T3>,T4>,T5>>> build, Action6<T0, T1, T2, T3, T4, T5> execute) {
        addEvent(event, other, build, (Action1<Toast2<Toast2<Toast2<Toast2<Toast2<T0,T1>,T2>,T3>,T4>,T5>>)execute);
    }
    public static <T0, T1, T2, T3, T4, T5, T6>void addEvent(String event, type other, Func1<Builder<Player>, Builder<Toast2<Toast2<Toast2<Toast2<Toast2<Toast2<T0,T1>,T2>,T3>,T4>,T5>,T6>>> build, Action7<T0, T1, T2, T3, T4, T5, T6> execute) {
        addEvent(event, other, build, (Action1<Toast2<Toast2<Toast2<Toast2<Toast2<Toast2<T0,T1>,T2>,T3>,T4>,T5>,T6>>)execute);
    }
    public static <T0, T1, T2, T3, T4, T5, T6, T7>void addEvent(String event, type other, Func1<Builder<Player>, Builder<Toast2<Toast2<Toast2<Toast2<Toast2<Toast2<Toast2<T0,T1>,T2>,T3>,T4>,T5>,T6>,T7>>> build, Action8<T0, T1, T2, T3, T4, T5, T6, T7> execute) {
        addEvent(event, other, build, (Action1<Toast2<Toast2<Toast2<Toast2<Toast2<Toast2<Toast2<T0,T1>,T2>,T3>,T4>,T5>,T6>,T7>>)execute);
    }
    public static <T0, T1, T2, T3, T4, T5, T6, T7, T8>void addEvent(String event, type other, Func1<Builder<Player>, Builder<Toast2<Toast2<Toast2<Toast2<Toast2<Toast2<Toast2<Toast2<T0,T1>,T2>,T3>,T4>,T5>,T6>,T7>,T8>>> build, Action9<T0, T1, T2, T3, T4, T5, T6, T7, T8> execute) {
        addEvent(event, other, build, (Action1<Toast2<Toast2<Toast2<Toast2<Toast2<Toast2<Toast2<Toast2<T0,T1>,T2>,T3>,T4>,T5>,T6>,T7>,T8>>)execute);
    }
//</generator>
    ...
    private static boolean execute(CommandSender sender, Command command, String label, String[] args) {
        ...
        Event event = events.getOrDefault(Toast.of(args[0], args.length - 1), null);
    ...
    private static boolean executeOther(CommandSender sender, Command command, String label, String[] args) {
        ...
        Event event = events.getOrDefault(Toast.of(args[1], args.length - 2), null);
