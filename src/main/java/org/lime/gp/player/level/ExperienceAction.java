...
public class ExperienceAction<TValue, TCompare> {
    ...
    public static final ExperienceAction<Block, Func1<IBlockData, Boolean>> BREAK = of("break", (e1, e2) -> e1 instanceof CraftBlock b && e2.invoke(b.getNMS()), v -> BlockFilter.createBlockTest("block="+v), BlockFilter::createBlockLine);
    public static final ExperienceAction<String, String> CRAFT = of("craft", Regex::compareRegex, v -> v, v -> v);
    ...
    public static final ExperienceAction<String, String> HARVEST = of("harvest", Regex::compareRegex, v -> v, v -> v);
    ...
    private final Func2<TValue, TCompare, Boolean> action;
    private final Func1<String, TCompare> parse;
    private final Func1<TValue, String> debug;
    private final boolean empty;

    private ExperienceAction(String key, Func2<TValue, TCompare, Boolean> action, Func1<String, TCompare> parse, Func1<TValue, String> debug, boolean empty) {
        this.key = key;
        this.action = action;
        this.parse = parse;
        this.debug = debug;
    ...
    private static <TValue, TCompare>ExperienceAction<TValue, TCompare> of(String key, Func2<TValue, TCompare, Boolean> action, Func1<String, TCompare> parse, Func1<TValue, String> debug) {
