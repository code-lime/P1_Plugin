...
import org.lime.system.delete.ChildDeleteHandle;
import org.lime.system.delete.IDelete;
...
public class Logged {
    ...
    public interface ILoggedDelete extends IDelete {
    ...
    public static class ChildLoggedDeleteHandle extends ChildDeleteHandle implements ILoggedDelete {
