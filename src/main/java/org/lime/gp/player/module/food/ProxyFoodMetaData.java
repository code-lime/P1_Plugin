...
public class ProxyFoodMetaData extends FoodMetaData {
    ...
    private float oldSaturationLevel = -1;
    private float oldExhaustionLevel = -1;
    private int oldSaturatedRegenRate = -1;
    private int oldUnsaturatedRegenRate = -1;
    private int oldStarvationRate = -1;
