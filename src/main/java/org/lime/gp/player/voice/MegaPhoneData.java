...
public class MegaPhoneData extends DistanceData {
    ...
    public MegaPhoneData(Settings.MegaPhoneSetting setting) {
    ...
    public static Optional<MegaPhoneData> getData(ItemStack item) {
        return Items.getOptional(Settings.MegaPhoneSetting.class, item).map(setting -> {
    ...
    public static void modifyData(ItemStack item, system.Action1<MegaPhoneData> modify) {
        Items.getOptional(Settings.MegaPhoneSetting.class, item).ifPresent(setting -> {
            ItemMeta meta = item.getItemMeta();
            modifyData(setting, meta, modify);
            item.setItemMeta(meta);
        });
    }
    public static void modifyData(Settings.MegaPhoneSetting setting, ItemMeta meta, system.Action1<MegaPhoneData> modify) {
        MegaPhoneData data = new MegaPhoneData(setting);
