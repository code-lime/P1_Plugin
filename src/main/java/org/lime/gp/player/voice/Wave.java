...
public class Wave {
    ...
    public static class WavFile {
        ...
        public static WavFile newWavFile(OutputStream output, int numChannels, long numFrames, int validBits, long sampleRate)
        ...
        // Short
        // ----mono:
        public int readFramesChanel(short[] sampleBuffer, int numFramesToRead, int channel)
                throws IOException, WavFileException {
            return readFramesChanel(sampleBuffer, 0, numFramesToRead, channel);
        }

        public int readFramesChanel(short[] sampleBuffer, int offset, int numFramesToRead, int channel)
                throws IOException, WavFileException {
        ...
        public int writeFrames(short[] sampleBuffer, int offset, int numFramesToWrite)
                throws IOException, WavFileException {
        ...
        /*public static void main(String[] args) {
            ...
            try {
                for (String filename : args) {
                    ...
                    WavFile writeWavFile = newWavFile(new File("out.wav"), numChannels, numFrames, validBits,
                            sampleRate);
     ...
     * WavFile wavFile = WavFile.newWavFile(new File(args[0]), 2, numFrames, 16,
     * sampleRate);
     * 
     * // Create a buffer of 100 frames
