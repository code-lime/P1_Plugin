...
public interface CauldronBlockInteraction {
    ...
    default EnumInteractionResult interact(CauldronInstance cauldron, ItemStack itemStack, BlockSkullEventInteract event) {
        return interact(cauldron, event.getWorld(), event.getPos(), event.getPlayer(), event.getHand(), itemStack);
    }
